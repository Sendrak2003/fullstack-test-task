...
С допущениями большого кол-во запросов реализовать:
- очередь с дедупликацией
- тех. гарантию того что одно и то-же значение не будет добавлено повторно.  
- батчинг добавления элементов раз в 10 сек,
- батчинг получения и изменения данных раз в секунду.
Технологии:
Бэкенд — Express.js


Фронтенд — на выбор разработчика (React + TS)
